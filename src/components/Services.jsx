...
const SVC = [
  ...
  },
  {
    ...
    detail: 'Formulación de políticas energéticas, en función a las necesidades reales, la seguridad energética y la planificación energética en base al análisis de mercado (Proyectos hidráulicos, RER, CT, entre otros). Experiencia en el diseño del Plan Nacional de Electrificación Rural.',
  ...
  },
  {
    ...
    detail: 'Estructuración de PPAs (Contratos de Suministro Eléctrico). Liderazgo en concurso y análisis de precio, plazos, garantías y riesgos para clientes libres versus generadoras/distribuidoras. Según el marco normativo actual, el cliente debe tener consumir 200 kW para migrar al mercado libre.',
    bullets: ['Ahorro del 30% del costo de energía eléctrica', 'Contratos de suministros de actualidad', '100% de éxito', 'Clientes libres'],
  ...
  },
  {
    ...
    detail: 'Diseño y dictado de programas de formación técnica y regulatoria para equipos corporativos del sector energía (público y privado). Más de 500 profesionales capacitados en regulación eléctrica, gas natural, proyectos RER, mercados y contratos.',
  ...
  },
  {
    ...
    detail: 'Monitoreo, análisis y asesoría en fijación de precios de combustibles líquidos. Evaluaciones económico-financieras de proyectos energéticos. Asesoría para la reducción de costos de suministro y proyección mediante optimización de cadena.',
  ...
  },
  {
    ...
    detail: 'Análisis regulatorio, técnico, legal, económico y financiero de proyectos minero - energéticos. Análisis y asesoría integral en Concesiones del sector energía.',
    bullets: ['Análisis Legal', 'Análisis técnico - regulatorio', 'Análisis económico/financiero', 'Concesiones'],
    kpi: { val: '10+', label: 'Proyectos asesorados al 100%' },
